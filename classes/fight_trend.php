...
<table class="table-responsive" style="width: 100%; height:260px;background-color:#1f2024">
				<tbody>
                    <?php echo $row1 ?>
                    <?php echo $row2 ?>
                    <?php echo $row3 ?>
...
<table class="table-responsive" style="width: 100%; height:240px;background-color:#1f2024">
				<tbody>
                    <?php echo $row1 ?>
                    <?php echo $row2 ?>
                    <?php echo $row3 ?>
