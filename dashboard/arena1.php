<?php if ($_settings->userdata('type') == 1 or $_settings->userdata('type') == 3 or $_settings->userdata('type') == 4): ?>
  ...
  <div class="site-wrapper">
    <div class="container-fluid">
        ...
        <div id="app" class="col-sm-5">
          ...
          <div class="betting-console">
            ...
            <div id="btn_game_fight">
              ...
              <!-- Meron Wala UI -->
              <!-- <div class="row">
                <div class="col p-1 text-center pt-3 dark-bg ">
                  ...
                  <div class="col p-0 text-center pt-0 bg-dark padding: 15px;" style="border-radius: 10px; border: 1px solid white;">
                    ...
                    <h3 id="total_meron_bets" style="color:yellow;">0.00</h3>
                    <h4 id="payout_meron">
                      <div>0<label style="font-size:17px;"></label>
                      </div>
                    </h4>

                    <h4><strong id="ur_meron_bets" class="text-success">0</strong>
                      <h4>
                        <div class="row">
                ...
                <div class="col p-1 text-center pt-3 dark-bg">
                  ...
                  <div class="col p-0 text-center pt-0 bg-dark padding: 15px;" style="border-radius: 10px; border: 1px solid white;">
                    ...
                    <h4><strong id="ur_wala_bets" class="text-success">0</strong>
                      <h4>
          ...
          <div class="row">
            <div class="col py-1 px-0 text-center pt-3 dark-bg ">

              <div class="col p-0 text-center pt-0 padding: 15px;" style="background-color: rgb(33, 33, 33);">
                ...
                <h3 id="total_meron_bets" class="meron-bets-v1">0.00</h3>
                <h4 id="payout_meron my-0" class="payout-text-v1">
                ...
                <div class="mt-2">
                  <span class="badge rounded-pill bg-secondary bet-pill">
                    <span>BET: ₱</span> <span id="ur_meron_bets">0.00</span>
                  </span>
                </div>

                <div class="mt-2">
                  <span class="badge rounded-pill bg-secondary pays-pill">
                    <span>PAYS: ₱</span> <span id="meron_bets">0.00</span>
                  </span>
                </div>
            ...
            <div class="col py-1 px-0 text-center pt-3 dark-bg">
              ...
              <div class="col p-0 text-center pt-0 padding: 15px;" style="background-color: rgb(26, 26, 26);">
                ...
                <h3 id="total_wala_bets" class="wala-bets-v1">0.00</h3>
                <h4 id="payout_wala my-0" class="payout-text-v1">
                ...
                <div class="mt-2">
                  <span class="badge rounded-pill bg-secondary pays-pill">
                    <span>PAYS: ₱</span> <span id="wala_bets">0.00</span>
                  </span>
                </div>

                <div class="mt-2">
                  <button type="button" id="post-wala" class="btn bet-btn w-100 post-bet py-2" style="background-color: #1565c0;" href="javascript:void(0)" betid=1>
          ...
          <!-- <div class="row">
            <div class="col text-left currentPointsDisplay" style="color: White; font-size:16px;"><i class="text-warning far fa-money-bill-alt"></i> BALANCE: <strong id="ur_points" class="text-warning" style="color: orange; font-size:18px;"></strong>
            </div>
            <div class="col-sm-12">
      ...
      <div class="card mb-8">
        <div class="card-body p-2 pb-0 bg-status_dash">
  ...
  <script>
      ...
      $.ajax({
        ...
        success: function(result) {
          ...
          if (result.red_payout !== redpayoutchecker) {
            ...
            $('#payout_meron_value').html(red_payout_replaced);
          }
          ...
          if (result.blue_payout !== bluepayoutchecker) {
            ...
            $('#payout_wala_value').html(blue_payout_replaced);
          }
        },
        error: function(data) {
    ...
    function animateValueUpdate(elementId, newValue) {
      ...
      if (targetValue > currentValue) {
        ...
        console.log('animateValueUpdate animate');
      } else {
        $element.html(targetValue)
        console.log('animateValueUpdate not animate');
      }
    }
